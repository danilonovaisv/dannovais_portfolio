...
var init = function() {
  ...
  light = new HemiLight();
  light.init(scene, get.radian(30), get.radian(60), 1000, 0xffff44, 0x0000cc, 1);
...
},{"./camera":1,"./debounce":2,"./get":3,"./hemiLight":4,"./mesh":6,"./pointLight":8}],6:[function(require,module,exports){
var Get = require('./get');
var get = new Get();
...
},{"./get":3,"./particle":7}],7:[function(require,module,exports){
var Get = require('./get');
var get = new Get();
...
},{"./get":3}],8:[function(require,module,exports){
var Get = require('./get');
var get = new Get();
